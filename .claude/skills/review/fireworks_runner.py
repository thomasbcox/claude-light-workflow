...
PASSES = {
    ...
    "design": {
        ...
        "prompt": (
            ...
            "best-practice lens and its guardrails from that contract. "
            ...
            "will challenge. Separately, critique the oracle mode and mechanism "
            "the author DID assign each criterion: flag any check derived from "
            "an implementation shape (a selector, assertion, or file token) "
            "rather than from the criterion, and "
            "any criterion whose named oracle cannot fail. Tag "
    ...
    "approach": {
        ...
        "prompt": (
            ...
            "its guardrails from that contract. Tag each finding with reversibility "
